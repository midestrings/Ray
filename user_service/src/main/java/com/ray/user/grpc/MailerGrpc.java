...
public final class MailerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ray.user.grpc.Email,
      com.ray.user.grpc.EmailResponse> getSendMailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMail",
      requestType = com.ray.user.grpc.Email.class,
      responseType = com.ray.user.grpc.EmailResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.ray.user.grpc.Email,
      com.ray.user.grpc.EmailResponse> getSendMailMethod() {
    io.grpc.MethodDescriptor<com.ray.user.grpc.Email, com.ray.user.grpc.EmailResponse> getSendMailMethod;
        ...
        if ((getSendMailMethod = MailerGrpc.getSendMailMethod) == null) {
          MailerGrpc.getSendMailMethod = getSendMailMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ray.user.grpc.EmailResponse.getDefaultInstance()))
  ...
  public static abstract class MailerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.ray.user.grpc.Email> sendMail(
        io.grpc.stub.StreamObserver<com.ray.user.grpc.EmailResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.ray.user.grpc.Email,
                com.ray.user.grpc.EmailResponse>(
  ...
  private static abstract class MailerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ray.user.grpc.EmailServiceImpl.getDescriptor();
    }
