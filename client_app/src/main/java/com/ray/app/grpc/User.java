...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              roles_ = new java.util.ArrayList<com.ray.app.grpc.UserRole>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.ray.app.grpc.UserServiceImpl.internal_static_user_User_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.ray.app.grpc.UserServiceImpl.internal_static_user_User_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.ray.app.grpc.User.class, com.ray.app.grpc.User.Builder.class);
  }
  ...
  private java.util.List<com.ray.app.grpc.UserRole> roles_;
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public java.util.List<com.ray.app.grpc.UserRole> getRolesList() {
    return roles_;
  }
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public java.util.List<? extends com.ray.app.grpc.UserRoleOrBuilder> 
   ...
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public com.ray.app.grpc.UserRole getRoles(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.ray.app.grpc.User)) {
  ...
  public static com.ray.app.grpc.User parseFrom(
  ...
  public static com.ray.app.grpc.User parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.ray.app.grpc.User parseFrom(
  ...
  public static com.ray.app.grpc.User parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.ray.app.grpc.User parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.ray.app.grpc.User parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.ray.app.grpc.User prototype) {
  ...
  public static final class Builder extends
      ...
      com.ray.app.grpc.UserOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.ray.app.grpc.UserServiceImpl.internal_static_user_User_descriptor;
    }
    ...
    // Construct using com.ray.app.grpc.User.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.ray.app.grpc.User getDefaultInstanceForType() {
      return com.ray.app.grpc.User.getDefaultInstance();
    }

    @java.lang.Override
    public com.ray.app.grpc.User build() {
      com.ray.app.grpc.User result = buildPartial();
    ...
    @java.lang.Override
    public com.ray.app.grpc.User buildPartial() {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.ray.app.grpc.User) {
        return mergeFrom((com.ray.app.grpc.User)other);
      } else {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.ray.app.grpc.User parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.ray.app.grpc.User) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureRolesIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        roles_ = new java.util.ArrayList<com.ray.app.grpc.UserRole>(roles_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.ray.app.grpc.UserRole, com.ray.app.grpc.UserRole.Builder, com.ray.app.grpc.UserRoleOrBuilder> rolesBuilder_;
    ...
    public Builder setRoles(
        int index, com.ray.app.grpc.UserRole value) {
      if (rolesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setRoles(
        int index, com.ray.app.grpc.UserRole.Builder builderForValue) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public Builder addRoles(com.ray.app.grpc.UserRole value) {
      if (rolesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRoles(
        com.ray.app.grpc.UserRole.Builder builderForValue) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
    ...
    public Builder addAllRoles(
        java.lang.Iterable<? extends com.ray.app.grpc.UserRole> values) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.app.grpc.UserRole.Builder getRolesBuilder(
        int index) {
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.app.grpc.UserRole.Builder addRolesBuilder() {
      return getRolesFieldBuilder().addBuilder(
          com.ray.app.grpc.UserRole.getDefaultInstance());
    }
    /**
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.app.grpc.UserRole.Builder addRolesBuilder(
        int index) {
      return getRolesFieldBuilder().addBuilder(
          index, com.ray.app.grpc.UserRole.getDefaultInstance());
    }
    /**
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public java.util.List<com.ray.app.grpc.UserRole.Builder> 
         getRolesBuilderList() {
      return getRolesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.ray.app.grpc.UserRole, com.ray.app.grpc.UserRole.Builder, com.ray.app.grpc.UserRoleOrBuilder> 
        getRolesFieldBuilder() {
      if (rolesBuilder_ == null) {
  ...
  private static final com.ray.app.grpc.User DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.ray.app.grpc.User();
  }

  public static com.ray.app.grpc.User getDefaultInstance() {
