...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              roles_ = new java.util.ArrayList<com.ray.schedule.grpc.UserRole>();
              mutable_bitField0_ |= 0x00000002;
            }
            roles_.add(
                input.readMessage(com.ray.schedule.grpc.UserRole.parser(), extensionRegistry));
            break;
          }
          case 42: {
            java.lang.String s = input.readStringRequireUtf8();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.ray.schedule.grpc.UserServiceImpl.internal_static_user_User_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.ray.schedule.grpc.UserServiceImpl.internal_static_user_User_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.ray.schedule.grpc.User.class, com.ray.schedule.grpc.User.Builder.class);
  }
  ...
  private java.util.List<com.ray.schedule.grpc.UserRole> roles_;
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public java.util.List<com.ray.schedule.grpc.UserRole> getRolesList() {
    return roles_;
  }
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public java.util.List<? extends com.ray.schedule.grpc.UserRoleOrBuilder> 
   ...
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public com.ray.schedule.grpc.UserRole getRoles(int index) {
    return roles_.get(index);
  }
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  public com.ray.schedule.grpc.UserRoleOrBuilder getRolesOrBuilder(
      int index) {
    return roles_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.ray.schedule.grpc.User)) {
      return super.equals(obj);
    }
    com.ray.schedule.grpc.User other = (com.ray.schedule.grpc.User) obj;
  ...
  public static com.ray.schedule.grpc.User parseFrom(
  ...
  public static com.ray.schedule.grpc.User parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.ray.schedule.grpc.User parseFrom(
  ...
  public static com.ray.schedule.grpc.User parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.ray.schedule.grpc.User parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.ray.schedule.grpc.User parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.ray.schedule.grpc.User prototype) {
  ...
  public static final class Builder extends
      ...
      com.ray.schedule.grpc.UserOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.ray.schedule.grpc.UserServiceImpl.internal_static_user_User_descriptor;
    }
    ...
    // Construct using com.ray.schedule.grpc.User.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.ray.schedule.grpc.User getDefaultInstanceForType() {
      return com.ray.schedule.grpc.User.getDefaultInstance();
    }

    @java.lang.Override
    public com.ray.schedule.grpc.User build() {
      com.ray.schedule.grpc.User result = buildPartial();
    ...
    @java.lang.Override
    public com.ray.schedule.grpc.User buildPartial() {
      com.ray.schedule.grpc.User result = new com.ray.schedule.grpc.User(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.ray.schedule.grpc.User) {
        return mergeFrom((com.ray.schedule.grpc.User)other);
      } else {
    ...
    public Builder mergeFrom(com.ray.schedule.grpc.User other) {
      if (other == com.ray.schedule.grpc.User.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.ray.schedule.grpc.User parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.ray.schedule.grpc.User) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureRolesIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        roles_ = new java.util.ArrayList<com.ray.schedule.grpc.UserRole>(roles_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.ray.schedule.grpc.UserRole, com.ray.schedule.grpc.UserRole.Builder, com.ray.schedule.grpc.UserRoleOrBuilder> rolesBuilder_;
    ...
    public Builder setRoles(
        int index, com.ray.schedule.grpc.UserRole value) {
      if (rolesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setRoles(
        int index, com.ray.schedule.grpc.UserRole.Builder builderForValue) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public Builder addRoles(com.ray.schedule.grpc.UserRole value) {
      if (rolesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRoles(
        com.ray.schedule.grpc.UserRole.Builder builderForValue) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
    ...
    public Builder addAllRoles(
        java.lang.Iterable<? extends com.ray.schedule.grpc.UserRole> values) {
      if (rolesBuilder_ == null) {
        ensureRolesIsMutable();
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.schedule.grpc.UserRole.Builder getRolesBuilder(
        int index) {
     ...
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.schedule.grpc.UserRole.Builder addRolesBuilder() {
      return getRolesFieldBuilder().addBuilder(
          com.ray.schedule.grpc.UserRole.getDefaultInstance());
    }
    /**
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public com.ray.schedule.grpc.UserRole.Builder addRolesBuilder(
        int index) {
      return getRolesFieldBuilder().addBuilder(
          index, com.ray.schedule.grpc.UserRole.getDefaultInstance());
    }
    /**
     * <code>repeated .user.UserRole roles = 3;</code>
     */
    public java.util.List<com.ray.schedule.grpc.UserRole.Builder> 
         getRolesBuilderList() {
      return getRolesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.ray.schedule.grpc.UserRole, com.ray.schedule.grpc.UserRole.Builder, com.ray.schedule.grpc.UserRoleOrBuilder> 
        getRolesFieldBuilder() {
      if (rolesBuilder_ == null) {
  ...
  private static final com.ray.schedule.grpc.User DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.ray.schedule.grpc.User();
  }

  public static com.ray.schedule.grpc.User getDefaultInstance() {
