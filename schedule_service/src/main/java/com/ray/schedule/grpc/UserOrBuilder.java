...
public interface UserOrBuilder extends
   ...
   */
  java.util.List<com.ray.schedule.grpc.UserRole> 
      getRolesList();
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  com.ray.schedule.grpc.UserRole getRoles(int index);
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  int getRolesCount();
   ...
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  java.util.List<? extends com.ray.schedule.grpc.UserRoleOrBuilder> 
