...
public interface UserOrBuilder extends
   ...
   */
  java.util.List<com.ray.vehicle.grpc.UserRole> 
      getRolesList();
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  com.ray.vehicle.grpc.UserRole getRoles(int index);
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  int getRolesCount();
   ...
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  java.util.List<? extends com.ray.vehicle.grpc.UserRoleOrBuilder> 
      getRolesOrBuilderList();
  /**
   * <code>repeated .user.UserRole roles = 3;</code>
   */
  com.ray.vehicle.grpc.UserRoleOrBuilder getRolesOrBuilder(
      int index);
