...
public final class MailerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ray.vehicle.grpc.Email,
      com.ray.vehicle.grpc.EmailResponse> getSendMailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMail",
      requestType = com.ray.vehicle.grpc.Email.class,
      responseType = com.ray.vehicle.grpc.EmailResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.ray.vehicle.grpc.Email,
      com.ray.vehicle.grpc.EmailResponse> getSendMailMethod() {
    io.grpc.MethodDescriptor<com.ray.vehicle.grpc.Email, com.ray.vehicle.grpc.EmailResponse> getSendMailMethod;
      ...
      synchronized (MailerGrpc.class) {
        if ((getSendMailMethod = MailerGrpc.getSendMailMethod) == null) {
          MailerGrpc.getSendMailMethod = getSendMailMethod = 
              io.grpc.MethodDescriptor.<com.ray.vehicle.grpc.Email, com.ray.vehicle.grpc.EmailResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "email.Mailer", "sendMail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ray.vehicle.grpc.Email.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ray.vehicle.grpc.EmailResponse.getDefaultInstance()))
  ...
  public static abstract class MailerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.ray.vehicle.grpc.Email> sendMail(
        io.grpc.stub.StreamObserver<com.ray.vehicle.grpc.EmailResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                com.ray.vehicle.grpc.Email,
                com.ray.vehicle.grpc.EmailResponse>(
  ...
  private static abstract class MailerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ray.vehicle.grpc.EmailServiceImpl.getDescriptor();
    }
